...
def carla_data_prep(root_path,
                    ...
                    out_dir,
                    with_plane=False):
    """Prepare data related to carla dataset.
    ...
    Args:
        ...
        with_plane (bool, optional): Whether to use plane information.
            Default: False.
    """
    carla.create_carla_info_file(root_path, info_prefix, with_plane)
    carla.create_reduced_point_cloud(root_path, info_prefix)
    ...
    # carla.export_2d_annotation(root_path, info_train_path)
    # carla.export_2d_annotation(root_path, info_val_path)
    # carla.export_2d_annotation(root_path, info_trainval_path)
    # carla.export_2d_annotation(root_path, info_test_path)
